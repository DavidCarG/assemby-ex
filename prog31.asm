;Programa en ensamblador, el cual lee dos numeros desde teclado para 
;posteriormente calcular la suma de los mismos y mostrarla en pantalla
;Es el prog25.asm modificado para que ahora si funcione cuando la suma
;de los numeros exceda de 9
;prog31.asm
;18/04/2024
